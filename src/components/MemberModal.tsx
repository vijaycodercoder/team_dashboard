      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="profile" >
          <Card >
           ...
           <div className="space-y-2 text-le ">
                <label className="text-sm font-semibold dark:text-white  text-gray-700">Bio</label>
                <p className="text-gray-600 leading-relaxed bg-gray-50 p-4 rounded-lg my-2 border">
               {modelData.bio}
                </p>
              </div>
              <div className="flex flex-col gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-semibold my-2 dark:text-white text-gray-700 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold dark:text-white text-gray-700 flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <TabsContent value="projects">
          <Card>
            <CardHeader>
              <CardDescription>
                <label className="text-sm font-semibold  dark:text-white  text-gray-700 ">Projects</label>
              <ul className="list-disc pl-5 space-y-1 text-gray-600 leading-relaxed my-2 bg-gray-50 p-4 rounded-lg border ">
